...
namespace SandelioSistema
{
    class Cnst
    {
        ...
        public static SqlConnection SqlCon = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\SandelioSistema\Database SQL\SandelioDB.mdf;Integrated Security=True;Connect Timeout=30");
